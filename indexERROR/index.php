        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-6 col-md-3"><i class="fa fa-book"></i>
                    <h4>Generales</h4>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Prohibido las faltas de respeto hacia usuarios o miembros de Staff.</p>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Prohibido cualquier ofensa, odio o fobia hacia un grupo de personas.</p>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Prohibido el uso de programas de terceros, scripts o mods que beneficien
                        tu experienceia y fastidien las de otros.</p>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Prohibido el uso excesivo del chat.</p>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Prohibido quejarse de la actuación o comportamiento de un miembro del
                        Staff, usar canal #reportes.</p>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> La palabra de un miembro de Staff es la ultima siempre.</p>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Prohibido vender dinero o pertenecias in-game con dinero o pertenecias
                        reales.</p>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Todo edificio o vehiculo debe seguir las leyes de la física.</p>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Prohibido el CarKill.</p>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Prohibido incitar a las personas a romper normas o rol.</p>
                </div>
                <div class="col-xs-6 col-md-3"><i class="fa fa-male"></i>
                    <h4>Rol</h4>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Prohibido el RDM, Random Deathmatch, matar sin motivo alguno.</p>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Prohibido el NLR, New Life Rule, la regla de la nueva vida.</p>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Prohibido evitar el FearRP, es el miedo que provoca un robo a mano armada (Armas de fuego)
                        o situaciones similares.</p>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Prohibido el Metagaming, es decir, hablar dentro de rol sobre una
                        situación fuera de rol o inversa.</p>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Prohibido el FailRP, usar información fuera de rol para beneficio dentro
                        de rol.</p>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Prohibido destruir vehiculos de otros usuarios intencionalmente.</p>
                </div>
                <div class="col-xs-6 col-md-3"><i class="fa fa-lock"></i>
                    <h4>Construcción</h4>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Prohibido construir en la calle o crear estructuras que obstruyan el
                        paso, tambien estructuras inadecuadas.</p>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Prohibido poner mas de dos lockers encima de vehiculo, excepto camiones que pueden llevar todo lo que puedan en la zona de carga.</p>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Máximo 2 plantes por casa, excepto granjas que tendrán ilimitados(max espacio).</p>
                </div>
                <div class="col-xs-6 col-md-3"><i class="fa fa-list"></i>
                    <h4>Trabajos</h4>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Prohibido atracar banco a menos que haya 3 policias como mínimo.</p>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Máximo que se puede pedir por rehen es 35.000€.</p>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Prohibido robar vehiculo policial.</p>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Prohibido usar vestimenta policial sin ser del rol.</p>
                    <p class="pTextJustify"><i class="fa fa-star-half-empty" style="font-size: 14px;"></i> Prohibido secuestrar/encerrar por mas de 20 minutos.</p>
                </div>
            </div>
        </div>
    </div>
...
if ($_POST) {
    ...
    try {
        ...
        $mail->Username = 'zoonimal.helper@gmail.com';                 // SMTP username
        $mail->Password = 'Z0on1mAls+TeaM';                           // SMTP password
        $mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
        $mail->Port = 465;                                    // TCP port to connect to

        //Recipients
        $mail->setFrom('zoonimal.helper@gmail.com', 'ZoonimalsRP');
        $mail->addAddress('zoonimal.helper@gmail.com', $_POST['name']);

        $mail->isHTML(true);                                  // Set email format to HTML
        $mail->Subject = 'REPORTES';

        $body = "<p>Sr/Sra. " . $_POST['name'] . " con el email " . $_POST['email'] . " ha tenido el siguiente problema.</p><br><br><p>" . $_POST['message'] . "</p>";
